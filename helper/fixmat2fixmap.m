function [FixMap]=fixmat2fixmap(fixmat,kernel,CropAmount,ResizeFactor,WeightField,varargin)
%[FixMap]=FixMat2FixMap(fixmat,kernel,CropAmount,ResizeFactor,WeightField,'fieldname','Value',...)
%
...
% weights.
FixMap = accumarray([y(:) x(:)]+1,w,[fixmat.rect(2) fixmat.rect(4)]+1);
